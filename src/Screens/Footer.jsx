                    ...
                    <div className="py-8 lg:py-16 lg:pe-16">
                        ...
                        <div className="mt-8 border-t border-gray-100 pt-8">
                            <ul className="flex flex-wrap gap-4 text-md">
                                <li>
                                    <a href={"mailto:devamkumar758@gmail.com"} className="text-gray-200 transition hover:opacity-75"> devamkumar758@gmail.com </a>
                                </li>

                                <li>
                                    <div className="text-gray-200 transition hover:opacity-75"> +91-6202121925 </div>
                                </li>
                            </ul>
