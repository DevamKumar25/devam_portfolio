...
import { Social, socials } from "../../../Utilities/Links.jsx";
...
function Description() {
    ...
    const description = "Hello, I am Devam Kumar. I am a Software Developer Intern at Findoc, building scalable backends and AI-driven solutions."
    return (
        <div className={"gap-6 h-full max-w-2xl flex justify-center items-start p-5 flex-col"}>
            ...
            <div onMouseEnter={mouseEnter} onMouseLeave={mouseLeave}>
                <motion.div
                    ...
                    className={"md:text-7xl md:leading-[85px] leading-[50px] text-5xl max-w-2xl font-medium"}>Devam
                    Kumar
                </motion.div>
                <motion.div
                    initial={{
                    ...
                    className={"md:text-7xl md:leading-[85px] leading-[50px] text-5xl max-w-2xl font-medium"}> <span
